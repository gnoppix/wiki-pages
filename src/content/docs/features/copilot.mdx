---
title: Gnoppix AI PlayGround 
description: Gnoppix AI PlayGround  
---
...
The Gnoppix AI [PlayGround](https://wiki.gnoppix.org/community/pilot) is a free public service offered by Gnoppix, a modern AI Linux Distribution with a strong focus on privacy and security. It is comparable to a GPT-like application. The difference to other GPT agents is that you can choose between almost all AI models, and you can build your own AI agent army on top. We have open-source AI models as well as the latest commercial ones, e.g., GPT-5 from OpenAI. The queries you submit are not used to train the models.
...
:::note
If you have existing keys from other providers, you can input additional API keys here
::: 
