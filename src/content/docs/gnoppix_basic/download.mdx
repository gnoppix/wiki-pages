...
*   [Gnoppix Beta Images](<https://beta.gnoppix.com/iso/>) access require Gnoppix Member sub.

:::note[INFO]
Gnoppix's default desktop environment is XFCE on Debian Linux. A public KDE version is planned for release in late 2025 / early 2026
