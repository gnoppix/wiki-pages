...
KDE Plasma can be considered as our "flagship" desktop environment, therefore it gets the most maintenance. The other Gnoppix's ISO
...
used for installation and recovering a broken install via arch-chroot.
